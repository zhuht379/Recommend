...
"""
LINE也是一种基于邻域相似假设的方法，使用BFS构造邻域的算法。不同的graph embedding方法的一个区别是对图中顶点之间的相似度的
定义不同。
Line算法定义的相似度：
first-order proximity:
1阶相似度用于描述图中成对顶点的局部相似度，形式化描述为u,v之间存在直连边，则边权Wuv即为两个顶点的相似度，若不存在直连边，则1阶
相似度为0

second-order proximity
Pu=(Wu,1,.....Wu,n)表示顶点u与所有其他顶点的1阶相似度，则u与v的2阶相似度可以通过Pu和Pv的相似度表示
